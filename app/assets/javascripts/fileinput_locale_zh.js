...
(function ($) {
    ...
    $.fn.fileinput.locales.zh = {
        ...
        msgFilesTooMany: '選擇的上傳照片個數 <b>({n})</b> 超出最大照片限制個數 <b>{m}</b>.',
        ...
        msgInvalidFileExtension: '不正確的副檔名 "{name}". 只支持 "{extensions}" 的照片副檔名.',
        msgValidationError: '照片上傳錯誤',
        msgLoading: '加载第 {index} 文件 共 {files} &hellip;',
        msgProgress: '加载第 {index} 文件 共 {files} - {name} - {percent}% 完成.',
        msgSelected: '{n} {files} 選取',
        msgFoldersNotAllowed: '只支持拖拽文件! 跳过 {n} 拖拽的文件夹.',
        dropZoneTitle: '拖曳照片到這裡 &hellip;',
