class Company < ActiveRecord::Base
  ...
  validates :phone_no, presence: { presence: true, message: '請填寫 農場電話' }, on: :update                       
  validates :postal, presence: { presence: true, message: '請填寫 農場地址-郵遞區號' }, on: :update  
  validates :county, presence: { presence: true, message: '請填寫 農場地址-縣市' }, on: :update  
  validates :district, presence: { presence: true, message: '請填寫 農場地址-鄉鎮市區' }, on: :update  
  validates :address, presence: { presence: true, message: '請填寫 農場地址-詳細地址' }, on: :update 
