...
=end
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :inventory, :unit, :preservation, :daily_capacity, :cold_chain, product_boxings_attributes:[:id, :quantity, :size, product_pricings_attributes:[:id, :quantity, :price]] )
    end
end
