Rails.application.configure do
  ...
  config.allpay_return_url  = 'http://register.ac-experts.com.tw/invoices/allpayNotify'  
  config.allpay_payment_info_url = 'http://register.ac-experts.com.tw/invoices/allpayPaymentInfoNotify'  
